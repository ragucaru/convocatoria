            ...
            <div class="row">
                <form >
                    ...
                    <div class="input-group mb-12">
                        <input type="text" name = "nom_filter" id= "nom_filter" class="form-control" placeholder="Nombre o Cédula" aria-label="Recipient's username" aria-describedby="basic-addon2">
                        <div class="input-group-append">
                            <button type='button' id='filtrar' class='btn btn-success' onclick="filtrare()" >FILTRARR</button> 
                        </div>
                    </div>                
